...
public class EquipmentRunner {
	...
	public static void main(String[] args) {
		...
		ArmorSet a = new ArmorSet(new Armor("Helm",3,2,"helmet"),new Armor("Chest", 5,2,"chestPlate"),new Armor("Gloves", 2,4,"gloves"),new Armor("Pants", 5,2,"greaves"),new Armor("Boots", 2, 3,"boots"), new Armor[0]);
